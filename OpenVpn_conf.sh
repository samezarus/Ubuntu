...
# Создание скрипта генерации файлов конфигурации /root/client-configs/make_config.sh
...
echo "> \${OUTPUT_DIR}/client1.ovpn"            >> $var_file

# Формируем коиентский конф. файл
bash ~/client-configs/make_config.sh client1
